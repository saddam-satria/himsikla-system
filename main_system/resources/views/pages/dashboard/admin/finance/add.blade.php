        ...
        <div class="row">
            <div class="col-sm-12 col-md-8">
                ...
                <div class="card card-primary">
                  ...
                  <form method="POST" action="{{route("dashboard.admin.finance.store")}}">
                    @csrf
                    @method("POST")
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input value="{{old("month")}}" type="month" name="month" id="month" class="form-control">
                      </div>
                      @include('components.form_validation', ["field" => "month"])

                      <div class="form-group">
                        <label for="payment">Metode Pembayaran</label><span class="text-danger">*</span>
                        <input value="{{old("payment")}}" type="text" name="payment" id="payment" class="form-control" placeholder="089999999 - OVO">
                      ...
                      <div class="form-group">
                        ...
                        <input value="{{old("penalty")}}" type="text" name="penalty" id="penalty"  class="form-control field-number" placeholder="Nominal Pembayaran (1000)">
                        <span style="font-size: 0.8em">Isi 0, jika tidak ada denda</span>
                      </div>
                      @include('components.form_validation', ["field" =>"penalty"])

                      @include('components.input_number', ["field" => "price", "placeholder" => "Nominal Angka(10200)" , "label" => "Nominal Kas"])
