            ...
            <div class="col-sm-12 col-md-8">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Tambah Data Neraca</h3>
                  </div>
                
                  <form method="POST" action="{{route("dashboard.admin.balance_sheet.store")}}">
                    @csrf
                    @method("POST")
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input value="{{old("debit")}}" type="text" name="debit" id="debit"  class="form-control field-number" placeholder="Nominal Debit (1000)">
                      </div>
                      ...
                      @include('components.input_number', ["field" => "kredit", "placeholder" => "Nominal Kredit (1000)", "label" => "Kredit" ])
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          @else
                            <input type="text"  class="form-control" disabled value="Data Pemasukan Kosong">
                          @endif
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          @else
                            <input type="text"  class="form-control" disabled value="Data Pengeluaran Kosong">
                          @endif
                        </div>
                      </div>
                    </div>
