...
@section('dashboard-content')
    ...
    <div class="container-fluid">
        ...
        <h1 class="text-xl text-capitalize">Daftar Absensi Pertemuan {{$meet->meetName . "-" . explode(" ",$meet->createdAt)[0]}}</h1>
        @include('components.export_button', array("pdf" => route("dashboard.admin.meet_absence.export", $meet->id)))
